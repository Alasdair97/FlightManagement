...
SELECT 
    ...
    STRFTIME('%H:%M',f.departure_time_utc,o.local_timezone_utc)AS Schedualed,
    STRFTIME('%H:%M',f.departure_time_utc,f.time_delay,o.local_timezone_utc) AS Expected,
    STRFTIME('%H:%M',f.arrival_time_utc,f.time_delay,d.local_timezone_utc) AS Arrival,
