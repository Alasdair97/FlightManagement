...
SELECT 
    ...
    STRFTIME('%H:%M',f.departure_time_utc) AS Schedualed,
    STRFTIME('%H:%M',f.departure_time_utc,f.time_delay) AS Expected,
    STRFTIME('%H:%M',f.arrival_time_utc,f.time_delay) AS Arrival,
